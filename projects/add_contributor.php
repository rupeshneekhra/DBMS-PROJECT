<?php
	...
	$sql = "insert into made_pro values(?,?);";
	...
	if ($stmt->affected_rows!=0 && $stmt->error=="") {
		?> <div style="border: solid 2px; padding: 20px;"><center> <h1> Operation Successful!!  </h1></center></div>
			<div style="border: solid 2px; padding: 20px;"><center> <h1> <a href="feed_research_pro_h.php" >Click here to add research areas.</a> </h1></center></div>
		<?php
	} else {
